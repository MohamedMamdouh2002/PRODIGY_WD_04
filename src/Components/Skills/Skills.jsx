...
const loop=[
    {name:<h1 className='font-mono text-2xl   -mt-4'>HTML5</h1>,
    ...
    {name:<h1 className='font-mono text-2xl  -mt-4'>CSS3</h1>,
     logo:<Lottie className='w-20 -mt-6' animationData={css} />,
     pre:'99%',
     index:2, 
     pro: '99',
  },
    {name:<h1 className='font-mono text-2xl  mt-3'>Bootstrap</h1>,
     logo:<i className="fa-brands fa-bootstrap fa-beat text-5xl mr-2 mt-2 text-indigo-500"></i>,
     pre:'90%',
     index:3, 
     pro: '90',
    },
    {name:<h1 className='font-mono text-2xl  mt-3'>Tailwindcss</h1>,
     logo:<img className='w-16 mt-3 skill2' src={tc} alt="" />,
     pre:'85%',
     index:4, 
     pro: '85',
    },
    {name:<h1 className='font-mono text-2xl  '>Javascript</h1>,
     logo:<Lottie className='w-20 -mt-2 ' animationData={js} />,
     pre:'95%',
     index:5, 
     pro: '95',
    },
    {name:<h1 className='font-mono text-2xl  mt-3'>Typescript</h1>,
     logo:<img className='w-14 skill2 mt-2 mr-2' src={ts} alt="" />,
     pre:'80%',
     index:6, 
     pro: '80',
    },
    {name:<h1 className='font-mono text-2xl  mt-3 ml-2'>Sass</h1>,
     logo:<i className="fa-brands fa-sass fa-bounce text-5xl text-fuchsia-500"></i>,
     pre:'80%',
     index:7, 
     pro: '80',
    },
    {name:<h1 className='font-mono text-2xl  mt-1 ml-1'>jquery</h1>,
     logo:<img className='w-14 skill2 ' src={jq} alt="" />,
     pre:'85%',
     index:8, 
     pro: '85',
    },
    {name:<h1 className='font-mono text-2xl  -mt-1 ml-1'>React</h1>,
     logo:<Lottie className='w-20 -mt-3' animationData={react} />,
     pre:'90%',
     index:10, 
     pro: '90',
    },
    {name:<h1 className='font-mono text-2xl  -mt-1 ml-1'>Next js</h1>,
    logo:<Lottie className='w-20 -mt-3' animationData={next} />,
    pre:'80%',
     index:11, 
     pro: '80',
    },
    {name:<h1 className='font-mono text-2xl  -mt-1 ml-1'>UI/Ux Design</h1>,
     logo:<Lottie className='w-20 -mt-3' animationData={figma} />,
     pre:'75%',
     index:12, 
     pro: '75',
    },
    {name:<h1 className='font-mono text-2xl   ml-1'>React Native</h1>,
     logo:<Lottie className='w-20 -mt-3' animationData={react} />,
     pre:'85%',
     index:9, 
     pro: '85',
    },
    {name:<h1 className='font-mono text-2xl  -mt-1 ml-1'>GIT & GITHUB</h1>,
...
return <>
    ...
    // viewport={{once:true}}
           className=" border h-28 p-3 rounded-sm relative text-black bg-white">
           
             <div className="end-1 absolute top-1  perBGColor   p-1  perBGColor perColor rounded-md" >{skill.pre}</div>
